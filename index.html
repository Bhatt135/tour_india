...
<body>
 ...
 <nav class="navbar glass" style="height: 70px">
  ...
  <ul class="nav-links">
   ...
   <li>
    <a href="#webchat-container" onclick="openChatbot()" id="quint" class="cir_border">Talk to Chatbot</a>
  ...
  <div class="container">
   ...
   <div class="row">
    <article class="card col">
     ...
     <p class="font-color">
      Diu Beach – A serene escape with golden sands, clear waters, and a perfect blend of relaxation and
      adventure!
     </p>
